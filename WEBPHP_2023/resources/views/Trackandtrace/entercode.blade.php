                ...
                <div class="card-body">
                    <div class="p-3 list-box col-10 mb-3 mx-auto">
                        <form action="{{route('getOrderView')}}" method="post">
                            ...
                            <input class="form-control" name="code" type="text" placeholder="{{ __('ui.track_and_trace_code') }}">
                            <input class="btn btn-secondary mt-3" type="submit" value="{{ __('ui.track_and_trace_button') }}">
                        </form>
                    </div>
                </div>
            </div>
